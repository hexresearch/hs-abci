...
instance (a ~ ExtensionRangeOptions, b ~ ExtensionRangeOptions,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "options" f DescriptorProto'ExtensionRange
           DescriptorProto'ExtensionRange
           a
           b
         where
...
instance (a ~ Prelude.Maybe ExtensionRangeOptions,
          b ~ Prelude.Maybe ExtensionRangeOptions, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'options" f
           DescriptorProto'ExtensionRange
           DescriptorProto'ExtensionRange
           a
           b
...
instance (a ~ [EnumDescriptorProto'EnumReservedRange],
          b ~ [EnumDescriptorProto'EnumReservedRange], Prelude.Functor f) =>
         Lens.Labels.HasLens "reservedRange" f EnumDescriptorProto
           EnumDescriptorProto
           a
           b
         where
...
instance (a ~ [Data.Text.Text], b ~ [Data.Text.Text],
          Prelude.Functor f) =>
         Lens.Labels.HasLens "reservedName" f EnumDescriptorProto
           EnumDescriptorProto
           a
           b
         where
...
instance (a ~ Data.Int.Int32, b ~ Data.Int.Int32,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "start" f EnumDescriptorProto'EnumReservedRange
           EnumDescriptorProto'EnumReservedRange
           a
           b
         where
...
instance (a ~ Prelude.Maybe Data.Int.Int32,
          b ~ Prelude.Maybe Data.Int.Int32, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'start" f
           EnumDescriptorProto'EnumReservedRange
           EnumDescriptorProto'EnumReservedRange
           a
           b
...
instance (a ~ Data.Int.Int32, b ~ Data.Int.Int32,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "end" f EnumDescriptorProto'EnumReservedRange
           EnumDescriptorProto'EnumReservedRange
           a
           b
         where
...
instance (a ~ Prelude.Maybe Data.Int.Int32,
          b ~ Prelude.Maybe Data.Int.Int32, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'end" f
           EnumDescriptorProto'EnumReservedRange
           EnumDescriptorProto'EnumReservedRange
           a
           b
...
instance (a ~ [UninterpretedOption], b ~ [UninterpretedOption],
          Prelude.Functor f) =>
         Lens.Labels.HasLens "uninterpretedOption" f ExtensionRangeOptions
           ExtensionRangeOptions
           a
           b
         where
...
instance Data.Default.Class.Default ExtensionRangeOptions where
        def
...
instance (a ~ FieldOptions'CType, b ~ FieldOptions'CType,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "ctype" f FieldOptions FieldOptions a b
         where
        lensOf _
          = (Prelude..) maybe'ctype
...
instance (a ~ Prelude.Bool, b ~ Prelude.Bool, Prelude.Functor f) =>
         Lens.Labels.HasLens "packed" f FieldOptions FieldOptions a b
         where
        lensOf _
...
instance (a ~ FieldOptions'JSType, b ~ FieldOptions'JSType,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "jstype" f FieldOptions FieldOptions a b
         where
        lensOf _
...
instance (a ~ Prelude.Bool, b ~ Prelude.Bool, Prelude.Functor f) =>
         Lens.Labels.HasLens "lazy" f FieldOptions FieldOptions a b
         where
        lensOf _
...
instance (a ~ Prelude.Bool, b ~ Prelude.Bool, Prelude.Functor f) =>
         Lens.Labels.HasLens "weak" f FieldOptions FieldOptions a b
         where
        lensOf _
...
instance (a ~ Data.Text.Text, b ~ Data.Text.Text,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "goPackage" f FileOptions FileOptions a b
         where
        lensOf _
...
instance (a ~ Prelude.Bool, b ~ Prelude.Bool, Prelude.Functor f) =>
         Lens.Labels.HasLens "phpGenericServices" f FileOptions FileOptions
           a
           b
         where
        lensOf _
          = (Prelude..) maybe'phpGenericServices
              (Data.ProtoLens.maybeLens Prelude.False)

instance (a ~ Prelude.Maybe Prelude.Bool,
          b ~ Prelude.Maybe Prelude.Bool, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'phpGenericServices" f FileOptions
           FileOptions
           a
           b
         where
...
instance (a ~ Data.Text.Text, b ~ Data.Text.Text,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "swiftPrefix" f FileOptions FileOptions a b
         where
        lensOf _
          = (Prelude..) maybe'swiftPrefix
              (Data.ProtoLens.maybeLens Data.ProtoLens.fieldDefault)

instance (a ~ Prelude.Maybe Data.Text.Text,
          b ~ Prelude.Maybe Data.Text.Text, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'swiftPrefix" f FileOptions FileOptions a
           b
         where
        lensOf _
...
instance (a ~ Data.Text.Text, b ~ Data.Text.Text,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "phpClassPrefix" f FileOptions FileOptions a b
         where
        lensOf _
          = (Prelude..) maybe'phpClassPrefix
              (Data.ProtoLens.maybeLens Data.ProtoLens.fieldDefault)

instance (a ~ Prelude.Maybe Data.Text.Text,
          b ~ Prelude.Maybe Data.Text.Text, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'phpClassPrefix" f FileOptions
           FileOptions
           a
           b
         where
...
instance (a ~ Data.Text.Text, b ~ Data.Text.Text,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "phpNamespace" f FileOptions FileOptions a b
         where
        lensOf _
          = (Prelude..) maybe'phpNamespace
              (Data.ProtoLens.maybeLens Data.ProtoLens.fieldDefault)

instance (a ~ Prelude.Maybe Data.Text.Text,
          b ~ Prelude.Maybe Data.Text.Text, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'phpNamespace" f FileOptions FileOptions
           a
           b
         where
        lensOf _
          ...
          = let javaPackage__field_descriptor
                ...
                phpGenericServices__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "php_generic_services"
                      (Data.ProtoLens.BoolField ::
                         Data.ProtoLens.FieldTypeDescriptor Prelude.Bool)
                      (Data.ProtoLens.OptionalField maybe'phpGenericServices)
                      :: Data.ProtoLens.FieldDescriptor FileOptions
                deprecated__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "deprecated"
                      (Data.ProtoLens.BoolField ::
              ...
              Data.ProtoLens.MessageDescriptor
                ...
                (Data.Map.fromList
                   [("java_package", javaPackage__field_descriptor),
                    ...
                    ("php_generic_services", phpGenericServices__field_descriptor),
                    ("deprecated", deprecated__field_descriptor),
                    ...
                    ("swift_prefix", swiftPrefix__field_descriptor),
                    ("php_class_prefix", phpClassPrefix__field_descriptor),
                    ("php_namespace", phpNamespace__field_descriptor),
                    ("uninterpreted_option", uninterpretedOption__field_descriptor)])
...
instance (a ~ MethodOptions'IdempotencyLevel,
          b ~ MethodOptions'IdempotencyLevel, Prelude.Functor f) =>
         Lens.Labels.HasLens "idempotencyLevel" f MethodOptions
           MethodOptions
           a
           b
         where
        lensOf _
          = (Prelude..) maybe'idempotencyLevel
              (Data.ProtoLens.maybeLens MethodOptions'IDEMPOTENCY_UNKNOWN)

instance (a ~ Prelude.Maybe MethodOptions'IdempotencyLevel,
          b ~ Prelude.Maybe MethodOptions'IdempotencyLevel,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'idempotencyLevel" f MethodOptions
           MethodOptions
           a
           b
         where
          ...
          = let deprecated__field_descriptor
                ...
                idempotencyLevel__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "idempotency_level"
                      ...
                      (Data.ProtoLens.OptionalField maybe'idempotencyLevel)
                      :: Data.ProtoLens.FieldDescriptor MethodOptions
                uninterpretedOption__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "uninterpreted_option"
                      (Data.ProtoLens.MessageField ::
              ...
              Data.ProtoLens.MessageDescriptor
                ...
                (Data.Map.fromList
                   [("deprecated", deprecated__field_descriptor),
                    ("idempotency_level", idempotencyLevel__field_descriptor),
                    ("uninterpreted_option", uninterpretedOption__field_descriptor)])
...
instance Data.Default.Class.Default MethodOptions'IdempotencyLevel
         where
        def = MethodOptions'IDEMPOTENCY_UNKNOWN
...
instance (a ~ OneofOptions, b ~ OneofOptions, Prelude.Functor f) =>
         Lens.Labels.HasLens "options" f OneofDescriptorProto
           OneofDescriptorProto
           a
           b
         where
...
instance (a ~ Prelude.Maybe OneofOptions,
          b ~ Prelude.Maybe OneofOptions, Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'options" f OneofDescriptorProto
           OneofDescriptorProto
           a
           b
         where
...
instance (a ~ [UninterpretedOption], b ~ [UninterpretedOption],
          Prelude.Functor f) =>
         Lens.Labels.HasLens "uninterpretedOption" f OneofOptions
           OneofOptions
           a
           b
         where
...
instance Data.Default.Class.Default OneofOptions where
        def = OneofOptions{_OneofOptions'uninterpretedOption = []}
...
idempotencyLevel ::
                 forall f s t a b .
                   (Lens.Labels.HasLens "idempotencyLevel" f s t a b) =>
                   Lens.Family2.LensLike f s t a b
idempotencyLevel
  = Lens.Labels.lensOf
...
maybe'idempotencyLevel ::
                       forall f s t a b .
                         (Lens.Labels.HasLens "maybe'idempotencyLevel" f s t a b) =>
                         Lens.Family2.LensLike f s t a b
maybe'idempotencyLevel
  = Lens.Labels.lensOf
      ((Lens.Labels.proxy#) ::
...
maybe'phpClassPrefix ::
                     forall f s t a b .
                       (Lens.Labels.HasLens "maybe'phpClassPrefix" f s t a b) =>
                       Lens.Family2.LensLike f s t a b
maybe'phpClassPrefix
  = Lens.Labels.lensOf
      ((Lens.Labels.proxy#) ::
...
maybe'phpGenericServices ::
                         forall f s t a b .
                           (Lens.Labels.HasLens "maybe'phpGenericServices" f s t a b) =>
                           Lens.Family2.LensLike f s t a b
maybe'phpGenericServices
  = Lens.Labels.lensOf
      ((Lens.Labels.proxy#) ::
...
maybe'phpNamespace ::
                   forall f s t a b .
                     (Lens.Labels.HasLens "maybe'phpNamespace" f s t a b) =>
                     Lens.Family2.LensLike f s t a b
maybe'phpNamespace
  = Lens.Labels.lensOf
...
maybe'swiftPrefix ::
                  forall f s t a b .
                    (Lens.Labels.HasLens "maybe'swiftPrefix" f s t a b) =>
                    Lens.Family2.LensLike f s t a b
maybe'swiftPrefix
  = Lens.Labels.lensOf
...
phpClassPrefix ::
               forall f s t a b .
                 (Lens.Labels.HasLens "phpClassPrefix" f s t a b) =>
                 Lens.Family2.LensLike f s t a b
phpClassPrefix
  = Lens.Labels.lensOf
...
phpGenericServices ::
                   forall f s t a b .
                     (Lens.Labels.HasLens "phpGenericServices" f s t a b) =>
                     Lens.Family2.LensLike f s t a b
phpGenericServices
  = Lens.Labels.lensOf
...
phpNamespace ::
             forall f s t a b .
               (Lens.Labels.HasLens "phpNamespace" f s t a b) =>
               Lens.Family2.LensLike f s t a b
phpNamespace
  = Lens.Labels.lensOf
...
swiftPrefix ::
            forall f s t a b . (Lens.Labels.HasLens "swiftPrefix" f s t a b) =>
              Lens.Family2.LensLike f s t a b
swiftPrefix
  = Lens.Labels.lensOf
